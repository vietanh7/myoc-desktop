...
Ext.define('MYOCD.view.featureTemplate.FeatureTemplateProductItemOwnedAtts', {
	extend: 'Ext.Panel',
	requires: [
		'Ext.grid.Panel',
	...
	flex: 1,
	xtype: 'featureTemplateProductItemOwnedAtts',
			...
			items: [
				{
					...
					store: 'featureTemplate.ProductItemAttributes',
					columns: [
						{
							xtype: 'actioncolumn',
							width: 40,
							...
							items: [
								{
									...
									handler: function(grid, rowIndex, colIndex) {
										...
										var parent = grid.up('featureTemplateProductItemOwnedAtts');
		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					name: 'featureTemplateProductSetAction'
				},
				{
					xtype: 'container',
					margin: 5,
