...
Ext.define('MYOCD.view.jobCatalog.JobOwnedAtts', {
	extend: 'Ext.Panel',
	requires: [
		'Ext.grid.Panel',
			...
			items: [
				{
					...
					name: 'jobOwnedAttsGrid',
					store: 'jobCatalog.JobAttributes',
					columns: [
						{
							xtype: 'actioncolumn',
							width: 40,
							...
							items: [
								{
									...
									handler: function(grid, rowIndex, colIndex) {
										...
										var parent = grid.up('jobOwnedAtts');
					...
					items: [
						...
						},
						{
				            ...
				            items: [
				                {
				                    boxLabel  : 'Hidden',
				                    name      : 'jobAttHiddenCheck'
				                }, 
				                {
				                    boxLabel  : 'Constant',
				                    name      : 'jobAttConstantCheck'
				                }, 
				                {
				                    boxLabel  : 'Mandatory',
				                    name      : 'jobAttMandatoryCheck'
				                },
				                {
					                boxLabel  : 'Deprecated',
					                name	  : 'jobAttDeprecatedCheck'
				                }
				            ]
				        },
				        {
					        xtype: 'textfield',
					        name: 'jobAttDefaultValue',
