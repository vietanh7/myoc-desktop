...
Ext.define('MYOCD.view.permissionLibrary.PermissionLibrariesTab', {
	...
	items: [
		{
			...
			flex: 1,
			border: false,
			name: 'permissionLibrariesGrid',
			title: 'Permission Libraries',
			tools: [
				{
					xtype: 'tool',
					name: 'newPermissionLibraryTool',
					type: 'plus'
				}
				// ,
				// {
				// 	xtype: 'tool',
				// 	name: 'permissionLibraryAuthorTool',
				// 	type: 'gear'
				// }
			],
			plugins: [
			...
			columnLines: true,
			store: 'permissionLibrary.PermissionLibraries',
			columns: [
				{
					xtype: 'actioncolumn',
					width: 40,
