var productLibAccess = Ext.create('Ext.data.Store', {
	fields: ['name', 'value'],
	data: [
...
Ext.define('MYOCD.view.productCatalog.ProductCatalogsTab', {
	...
	items: [
		{
			...
			flex: 1,
			border: false,
			name: 'productCatalogLibrariesGrid',
			title: 'Product Catalogs Libraries',
			tools: [
				{
					xtype: 'tool',
					name: 'newProductCatalogsLibTool',
					type: 'plus'
				}
				// ,
				// {
				// 	xtype: 'tool',
				// 	name: 'productCatalogLibrariesAuthorTool',
				// 	type: 'gear'
				// }
			],
			plugins: [
			...
			columnLines: true,
			store: 'productCatalog.ProductCatalogLibs',
			columns: [
				{
					xtype: 'actioncolumn',
					width: 40,
