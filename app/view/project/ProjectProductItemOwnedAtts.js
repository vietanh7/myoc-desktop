...
Ext.define('MYOCD.view.project.ProjectProductItemOwnedAtts', {
	extend: 'Ext.Panel',
	requires: [
		'Ext.grid.Panel',
	...
	flex: 1,
	xtype: 'projectProductItemOwnedAtts',
	layout: 'border',
	items: [
		{
			xtype: 'container',
			...
			items: [
				{
					...
					store: 'project.ProductItemAttributes',
					columns: [
						{
							xtype: 'actioncolumn',
							width: 40,
							...
							items: [
								{
									...
									handler: function(grid, rowIndex, colIndex) {
										...
										var parent = grid.up('projectProductItemOwnedAtts');
