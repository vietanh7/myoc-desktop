var assignedItemAllPermissionStore = Ext.create('Ext.data.Store', {
	fields: [
...
Ext.define('MYOCD.view.project.security.ProjectSecurityEditAssignedItem',{
	extend: 'Ext.window.Window',
	xtype: 'projectSecurityEditAssignedItem',
	width: 600,
	height: 500,
	...
	items: [
		...
		},
		{
			...
			columnLines: true,
			store: assignedItemAllPermissionStore,
			columns: [
				{
					xtype: 'actioncolumn',
					width: 40,
