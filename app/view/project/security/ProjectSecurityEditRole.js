var projectRoleAllPermissionStore = Ext.create('Ext.data.Store', {
	fields: [
...
Ext.define('MYOCD.view.project.security.ProjectSecurityEditRole',{
	extend: 'Ext.Panel',
	...
	items: [
		...
		},
		{
			...
			columnLines: true,
			store: projectRoleAllPermissionStore,
			columns: [
				{
					xtype: 'actioncolumn',
					width: 40,
