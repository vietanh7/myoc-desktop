var projectUsersPermissionsStore = Ext.create('Ext.data.Store', {
	fields: [
...
Ext.define('MYOCD.view.project.security.ProjectUsersPermissions', {
	extend: 'Ext.Panel',
	...
	items: [
		...
		},
		{
			...
			columnLines: true,
			store: projectUsersPermissionsStore,
			columns: [
				{
					xtype: 'actioncolumn',
					width: 40,
