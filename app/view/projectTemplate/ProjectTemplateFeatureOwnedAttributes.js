...
Ext.define('MYOCD.view.projectTemplate.ProjectTemplateFeatureOwnedAttributes', {
	extend: 'Ext.Panel',
	requires: [
		'Ext.grid.Panel',
			...
			items: [
				{
					...
					store: 'projectTemplate.FeatureAttributes',
					columns: [
		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					name: 'projectTemplateFeatureSetAction'
				},
				{
					xtype: 'container',
					margin: 5,
