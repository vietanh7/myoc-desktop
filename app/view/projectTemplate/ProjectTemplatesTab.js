var projectLibAccess = Ext.create('Ext.data.Store', {
	fields: ['name', 'value'],
	data: [
...
Ext.define('MYOCD.view.projectTemplate.ProjectTemplatesTab', {
	...
	items: [
		{
			...
			flex: 1,
			border: false,
			name: 'projectTemplatesLibrariesGrid',
			title: 'Project Templates Libraries',
			tools: [
				{
					xtype: 'tool',
					name: 'newProjectTemplatesLibTool',
					type: 'plus'
				}
				// ,
				// {
				// 	xtype: 'tool',
				// 	name: 'projectTemplatesLibAuthorTool',
				// 	type: 'gear'
				// }
			],
			plugins: [
			...
			columnLines: true,
			store: 'projectTemplate.ProjectTemplatesLibs',
			columns: [
				{
					xtype: 'actioncolumn',
					width: 40,
